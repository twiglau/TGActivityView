//
//  TGActivityView.swift
//  miaozhi
//
//  Created by liuzhiya on 2020/5/13.
//  Copyright © 2020 Luoyang Fiat. All rights reserved.
//
// usage:
// 1. activity = TGActivityViewController(message: "消息")
// 2. topViewController?.present(activity, animated: true, completion: nil)
// 3. activity.dismiss(animated: true) {
//    do something
//}

import UIKit
class TGActivityViewController: UIViewController {
    public let activityView = TGActivityView()
...
@objc open class TGActivityView: UIView {
    ...
    open override func layoutSubviews() {
        ...
        boundingBoxView.frame.size.width = 140.0
        ...
        let messageLabelSize = messageLabel.sizeThatFits(CGSize(width: 140.0 - 20.0 * 2.0, height: CGFloat.greatestFiniteMagnitude))
